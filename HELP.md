...
* The original package name 'com.aftercare.aftercare-api' is invalid and this project uses 'com.aftercare.aftercareapi' instead.
...
```
$ docker run --rm -p 8080:8080 aftercare-api:0.0.1-SNAPSHOT
```
